...
import org.openqa.selenium.support.FindBy;
	...
	public class ToolsqaHomePage {
		...
		@FindBy(xpath="//ul[@id='main-nav']/li[6]/a/span[text()='ABOUT']")
		public WebElement about;
		
		@FindBy(xpath="//ul[@id='main-nav']/li[7]/a/span[text()='CONTACTS']")
		public WebElement contacts;
		
		@FindBy(xpath="//ul[@id='main-nav']/li[8]/a/span[text()='DEMO SITES']")
		public WebElement demoSites;
		
		@FindBy(xpath="//ul[@id='main-nav']/li[9]/a/span[text()='TESTIMONIALS']")
		public WebElement testimonials;
		
		//Identify all element in sub navigation for DEMO SITES
		
		@FindBy(xpath="//ul[@id='main-nav']/li[8]/ul[@class='sub-nav']/li[1]/a/span[contains(.,'E-Commerce')]")
		public WebElement eCommerceSite;
		
		@FindBy(xpath="//ul[@id='main-nav']/li[8]/ul[@class='sub-nav']/li[2]/a/span[contains(.,'Basic Demo')]")
		public WebElement basicDemoSite;
		
		@FindBy(xpath="//ul[@id='main-nav']/li[8]/ul[@class='sub-nav']/li[3]/a/span[contains(.,'Automation Practice')]")
		public WebElement automationPracticeForm;
		
		@FindBy(xpath="//ul[@id='main-nav']/li[8]/ul[@class='sub-nav']/li[4]/a/span[contains(.,'Switch Windows')]")
		public WebElement switchWindows;
		
		@FindBy(xpath="//ul[@id='main-nav']/li[8]/ul[@class='sub-nav']/li[5]/a/span[contains(.,'Table')]")
		public WebElement automationTable;
		
		@FindBy(xpath="//ul[@id='main-nav']/li[8]/ul[@class='sub-nav']/li[6]/a/span[contains(.,'Alerts')]")
		public WebElement webdriverAlerts;
		
		@FindBy(xpath="//ul[@id='main-nav']/li[8]/ul[@class='sub-nav']/li[7]/a/span[contains(.,'IFrame')]")
